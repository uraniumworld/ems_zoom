                ...
                {lang=='TH'?
                    <>
                        ...
                        <div className="mb-2" style={{color:'red'}}>
                            ...
                            <a href="https://kku.world/6p7ss" target='_blank' className="ml-1 btn btn-dark">แบบฟอร์มขอใช้เครื่องของศูนย์ในการสอบ (คลิก)</a> แจ้งชื่อ-นามสกุล รหัสนักศึกษา และ รอบที่ต้องการข้อใช้เครื่องในการสอบ
                        </strong>
                        </div>
                    </>
                    :
                    <>
                        ...
                        <div className="mb-2" style={{color:'red'}}>
                            ...
                            <a href="https://kku.world/6p7ss" target='_blank' className="ml-1 btn btn-dark">Request form (Click)</a> Inform the first name and surname, student's code, and schedule time that you want to use the computer for the exam.
                        </strong>
                        </div>
                    </>
                }
